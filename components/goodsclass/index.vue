<template>
	<div class="symbin-goodsclass-ui">
	
		<div class="symbin-goodsclass-title">
		...
		<Modal v-model="modal1" title="广告">
			...
			<div class="symbin-goodsclass-addinfo">
	
				<Form ref="formItem" :model="formItem" :rules="ruleValidate" :label-width="100">
	
					<FormItem label="商品分类名称" prop="goodsclassname">
	
						<Input v-model="formItem.goodsclassname" placeholder="商品分类名称"></Input>
	...
	export default {
		...
		methods: {
			...
			add() { //增加
				...
				var formparams = {
					goodsclassname: s.formItem.goodsclassname,
				}
	
				symbinUtil.ajax({
	
					url: window.config.baseUrl + "/admin/addgoodsclass",
			...
			show(index) {
				...
				s.currentIndex = s.listData[index].goodsclassid;
				
				s.formItem = {
					goodsclassid: s.listData[index].goodsclassid,
					goodsclassname: s.listData[index].goodsclassname,
			...
			edit(goodsclassid) { //编辑
				...
				symbinUtil.ajax({
					...
					url: window.config.baseUrl + "/admin/editgoodsclass",
					validate: s.validateData,
					data: formparams,
					fn(data) {
						//console.log(data);
			...
			remove(goodsclass) { //删除
	
				var goodsclassids = goodsclass.goodsclassid;
	
				var s = this;
	
				symbinUtil.ajax({
	
					url: window.config.baseUrl + "/admin/delgoodsclass",
